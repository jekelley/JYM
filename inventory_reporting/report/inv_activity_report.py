...
class ReportInvActivityReports(models.AbstractModel):
    _name = 'report.inventory_reporting.report_inv_activity_reports'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        if data['form']['product_id']:
            ...
            if data['form']['item_categ'] and product_id.categ_id.id != \
                ...
                raise UserError(_(
                    'The category of the selected product does not match with the selected category.'))
